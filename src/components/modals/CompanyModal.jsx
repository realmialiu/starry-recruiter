...
export default function CompanyModal({ data, onSave, onDelete, onClose }) {
  ...
  const [f, set] = useFormState({ id: data.id || uid(), name: data.name || "", track: data.track || Object.keys(tracks)[0], stage: data.stage || "Interested", role: data.role || "", notes: data.notes || "" });

...
export default function WindowModal({ data, onSave, onDelete, onClose }) {
  ...
  const [f, set] = useFormState({ id: data.id || uid(), company: data.company || "", program: data.program || "", track: data.track || Object.keys(tracks)[0], expectedLabel: data.expectedLabel || "",
